...
DROP POLICY IF EXISTS "Authorized roles can create SMS notifications" ON sms_notifications;
DROP POLICY IF EXISTS "Admins can update SMS notifications" ON sms_notifications;
